...
import javax.swing.*;
public class MienDongNamBo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MienDongNamBo frame = new MienDongNamBo();
	...
	public MienDongNamBo() {
		...
		comboBox_1_1.setModel(new DefaultComboBoxModel(new String[] {"BÀ RỊA-VT", "BÌNH DƯƠNG", "BÌNH PHƯỚC","ĐỒNG NAI", "TÂY NINH", "TP.HỒ CHÍ MINH","--Tất Cả--"}));
