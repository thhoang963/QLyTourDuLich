...
import javax.swing.*;
public class MienTrung extends JFrame {
	...
	public MienTrung() {
		...
		comboBox_1_1.setModel(new DefaultComboBoxModel(new String[] {"HUẾ", "QUẢNG TRỊ", "QUẢNG BÌNH","QUẢNG NAM", "ĐÀ NẴNG", "BUÔN MÊ THUẬT","--Tất Cả--"}));
