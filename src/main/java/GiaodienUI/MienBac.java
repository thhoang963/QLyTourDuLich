...
import javax.swing.*;
public class MienBac extends JFrame {
	...
	public MienBac() {
		...
		comboBox_1_1.setModel(new DefaultComboBoxModel(new String[] {"CAO BẰNG", "LẠNG SƠN", "THANH HÓA","HÀ GIANG", "LÀO CAI", "HẢI PHÒNG","--Tất Cả--"}));
